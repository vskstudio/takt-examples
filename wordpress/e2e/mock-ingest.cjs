// Minimal Takt ingest stand-in for the example's E2E: records POST /api/event
// payloads and exposes them over GET /__events so specs can assert what the
// plugin sent. A real Takt instance replaces this entirely.
